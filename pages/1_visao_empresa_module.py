...
def traffic_order_share ( df1 ):
    #agrupar número de entregas por tipo de tráfego
    df_aux = (df1.loc[:, ['Road_traffic_density', 'ID']]
                  .groupby('Road_traffic_density')
                  .count()
                  .reset_index())
    
    #Calcular o percentual de pedidos para cada tipo de tráfego
    df_aux['entregas_perc'] = df_aux['ID']/ df_aux['ID'].sum()
              
    #grafico de pizza com percentuais
